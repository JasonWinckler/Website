...
- `corissia.webp` — Corissia Resorts gallery tile image from the Beacons page.
- `waterdrop.webp` — Waterdrop® gallery tile image from the Beacons page.
